...
class TaskManager:
    def __init__(self):
        ...
        self.api_key = 'b5933f2348f15da5048085085dd53dfb'
        self.city = 'Shanghai'
        ...
        self.weather_label = ttk.Label(self.root, text="Weather: Loading...", font=('Arial', 10))
        self.weather_label.pack(pady=5, anchor='e', padx=10)
        self.update_weather()
    ...
    def update_status_bar(self):
        ...
        status_text = f"Tasks: {self.task_count} | Accomplished: {self.accomplished_count}"
        self.status_bar.config(text=status_text)

    def get_weather(self):
        """Get weather data for Shanghai"""
        complete_url = f"{self.base_url}appid={self.api_key}&q={self.city}"
    ...
    def update_weather(self):
        ...
        try:
            ...
            if weather_data:
                temp = round(weather_data['main']['temp'] - 273.15, 1)  # Convert Kelvin to Celsius
                weather_desc = weather_data['weather'][0]['description']
                weather_text = f"Shanghai Weather: {temp}°C, {weather_desc}"
            else:
