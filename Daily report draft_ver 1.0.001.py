...
class TaskManager:
    ...
    def on_drag_start(self, event):
        ...
        if widget.curselection():
            ...
            widget.dnd_bind('<<DragInitCmd>>', self.on_drag_init)

    def on_drag_init(self, event):
        return (self.drag_data, tk.DND_TEXT)
        ...
        try:
            ...
            for priority, tasks in self.tasks.items():
                ...
                if tasks:  # If there are tasks in this priority
                    ...
                    pdf.cell(0, 10, "No tasks", ln=True)
                    
                pdf.ln(5)  # Add some space between priority sections
